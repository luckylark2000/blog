...
![alt text](/images/uml-interface-class.png)

## 泛化

空三角箭头，实线
![alt text](/images/uml-class-object.png)

## 关联

一个类与另一个类有关系，普通箭头，实线。可细分为聚合、组合、依赖（这三种了解即可）
![alt text](/images/uml-relevance.png)

### 聚合

整体包含部分，部分可以脱离整体而存在
![alt text](/images/uml-polymerization.png)

### 组合

整体包含部分，部分不可以脱离整体
![alt text](/images/uml-combination.png)

### 依赖

不是属性关系，而是函数参数或返回值
![alt text](/images/uml-depend-on.png)
